  ...
  <div
    ...
    <p className="flex text-sm text-slate-600">
      ...
      {percentage && percentage !== "NaN%" && (
        <span className="ml-1 rounded-xl px-2 py-1 text-xs bg-slate-100">{percentage}</span>
      )}
    </p>
...
export default function SummaryMetadata({ surveySummary }: SummaryMetadataProps) {
  ...
  return (
    <div className="flex flex-col-reverse gap-y-2 lg:flex-row lg:gap-x-2 ml-0 mt-7 py-4">
