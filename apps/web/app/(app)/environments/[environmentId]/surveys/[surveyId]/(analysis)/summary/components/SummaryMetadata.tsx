  ...
  <div
    ...
    <p className="flex text-sm text-slate-600">
      ...
      {percentage && percentage !== "NaN%" && (
        /*Change inner text for span tag from 5% to 50%*/<span className="ml-1 rounded-xl px-2 py-1 text-xs bg-[#ced9e5]">{percentage}</span>
      )}
    </p>
...
export default function SummaryMetadata({ surveySummary }: SummaryMetadataProps) {
  ...
  return (
    <div className="flex flex-col-reverse gap-y-2 py-4 lg:flex-row lg:gap-3">
      <StatCard
        label="Displays"
        percentage="100%"
