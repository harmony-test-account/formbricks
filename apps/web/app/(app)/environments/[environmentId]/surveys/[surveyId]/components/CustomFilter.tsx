...
const CustomFilter = ({ environmentTags, attributes, survey }: CustomFilterProps) => {
  ...
  return (
    <>
      <div className="relative flex gap-[15px] mr-0 mb-0 py-5">
        <ResponseFilter />
        <DropdownMenu
          onOpenChange={(value) => {
          ...
          <DropdownMenuTrigger className="flex h-auto items-center justify-between rounded-md border border-slate-200 bg-white p-3 hover:border-slate-300 sm:px-6 sm:py-3 ml-1.5 my-0">
        ...
        <DropdownMenu
          ...
          <DropdownMenuTrigger className="flex h-auto items-center justify-between rounded-md border border-slate-200 bg-white p-3 hover:border-slate-300 sm:px-6 sm:py-3 ml-0 my-0">
