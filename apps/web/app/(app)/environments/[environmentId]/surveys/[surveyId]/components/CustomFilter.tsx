...
const CustomFilter = ({ environmentTags, attributes, survey }: CustomFilterProps) => {
  ...
  return (
    <>
      <div className="relative mb-6 flex py-5 gap-[22px] pb-5">
        <ResponseFilter />
        <DropdownMenu
          onOpenChange={(value) => {
          ...
          <DropdownMenuTrigger className="flex h-auto items-center justify-between rounded-md border border-slate-200 bg-white p-3 hover:border-slate-300 sm:px-6 sm:py-3 ml-0.5">
        ...
        <DropdownMenu
          ...
          <DropdownMenuTrigger className="flex h-auto items-center justify-between rounded-md border border-slate-200 bg-white p-3 hover:border-slate-300 sm:px-6 sm:py-3 ml-0">
            <span className="text-slate-700 text-[17px]">Updates</span>
