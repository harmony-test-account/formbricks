...
const SummaryHeader = ({
  ...
  return (
    <div className="mb-6 mt-6 flex items-center justify-between gap-0">
      <div>
      ...
      {!isViewer && (
        <Button
          variant="darkCTA"
          className="px-3 lg:px-6 gap-1 justify-end items-start h-auto w-auto pl-[106px] pr-[86px] py-3"
          href="#"
