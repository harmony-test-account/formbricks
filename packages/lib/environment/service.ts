...
export const getEnvironment = async (_environmentId: string): Promise<TEnvironment | null> => {
...
export const getEnvironments = async (_productId: string): Promise<TEnvironment[]> => {
  ...
  //   }
  // )();
  const environments = [(await getEnvironment(""))!];
