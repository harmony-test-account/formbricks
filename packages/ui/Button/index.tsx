    ...
    elementType,
    {
      ...
      className: cn(
        ...
        variant === "darkCTA" &&
          (disabled
            ? "text-slate-400 dark:text-slate-500 bg-slate-200 dark:bg-slate-800"
            : "text-slate-100 hover:text-slate-50 bg-slate-900 hover:bg-slate-800 dark:text-slate-300 focus:outline-none focus:ring-2 focus:ring-offset-1  focus:bg-slate-700 focus:ring-neutral-500"),
